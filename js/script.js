...
const WORD_BANK = [
  {
    category: "Animais",
    words: {
      facil: ["Cachorro", "Gato", "Macaco", "Elefante", "Leão", "Pato", "Cavalo", "Sapo", "Peixe", "Coelho", "Urso", "Vaca", "Porco", "Ovelha", "Rato"],
      medio: ["Girafa", "Canguru", "Tartaruga", "Jacaré", "Coruja", "Pinguim", "Golfinho", "Camaleão", "Tamanduá", "Arara", "Rinoceronte", "Hipopótamo", "Tigre", "Zebra", "Polvo"],
      dificil: ["Ornitorrinco", "Suricato", "Narval", "Dragão-de-komodo", "Axolote", "Lêmure", "Peixe-boi", "Quati", "Morsa", "Capivara", "Avestruz", "Bicho-preguiça", "Louva-a-deus", "Alce", "Hiena"],
    },
  },
  {
    category: "Objetos",
    words: {
      facil: ["Celular", "Cadeira", "Óculos", "Chave", "Caneta", "Guarda-chuva", "Livro", "Bola", "Relógio", "Mochila", "Computador", "Copo", "Faca", "Sabonete", "Cama"],
      medio: ["Liquidificador", "Aspirador", "Escada", "Violão", "Martelo", "Controle remoto", "Travesseiro", "Lanterna", "Capacete", "Tesoura", "Geladeira", "Ventilador", "Pneu", "Despertador", "Secador de cabelo"],
      dificil: ["Estetoscópio", "Bússola", "Binóculo", "Extintor", "Gramofone", "Ampulheta", "Megafone", "Saca-rolhas", "Drone", "Microscópio", "Caleidoscópio", "Bigorna", "Paraquedas", "Telescópio", "Máquina de escrever"],
    },
  },
  {
    category: "Profissões",
    words: {
      facil: ["Médico", "Professor", "Bombeiro", "Dentista", "Cozinheiro", "Policial", "Pintor", "Cantor", "Motorista", "Garçom", "Ator", "Fazendeiro", "Pescador", "Gari", "Juiz"],
      medio: ["Fotógrafo", "Jardineiro", "Padeiro", "Mecânico", "Cabeleireiro", "Arquiteto", "Carteiro", "Repórter", "Veterinário", "Dançarino", "Engenheiro", "Advogado", "Costureira", "Enfermeiro", "Mágico"],
      dificil: ["Astronauta", "Maestro", "Arqueólogo", "Sommelier", "Dublador", "Piloto de avião", "Ilusionista", "Oceanógrafo", "Joalheiro", "Perito criminal", "Apicultor", "Acupunturista", "Taxidermista", "Mestre de obras", "Desembargador"],
    },
  },
  {
    category: "Ações (verbos)",
    words: {
      facil: ["Correr", "Dormir", "Comer", "Dançar", "Nadar", "Pular", "Chorar", "Rir", "Cantar", "Escovar os dentes", "Pular corda", "Ler", "Escrever", "Beber", "Tomar banho"],
      medio: ["Malhar", "Cozinhar", "Pescar", "Fotografar", "Costurar", "Surfar", "Meditar", "Dirigir", "Regar plantas", "Fazer compras", "Varrer", "Passar roupa", "Lavar louça", "Trocar pneu", "Amarrar o tênis"],
      dificil: ["Hipnotizar", "Esquiar", "Equilibrar pratos", "Desfilar", "Fazer malabarismo", "Mergulhar", "Maquiar", "Consertar encanamento", "Tocar bateria", "Escalar", "Tricotar", "Ordenhar", "Esculpir", "Reger orquestra", "Domar"],
    },
  },
  {
    category: "Esportes",
    words: {
      facil: ["Futebol", "Vôlei", "Basquete", "Tênis", "Natação", "Boxe", "Corrida", "Ciclismo", "Judô", "Skate", "Ping-pong", "Queimada", "Peteca", "Atletismo", "Capoeira"],
      medio: ["Golfe", "Handebol", "Surfe", "Ginástica", "Beisebol", "Badminton", "Rugby", "Boliche", "Esgrima", "Arco e flecha", "Esqui", "Patinação", "Levantamento de peso", "Alpinismo", "Canoagem"],
      dificil: ["Polo aquático", "Curling", "Críquete", "Salto com vara", "Hóquei no gelo", "Pentatlo", "Remo", "Escalada esportiva", "Taekwondo", "Lançamento de disco", "Bobsled", "Squash", "Kitesurf", "Slackline", "Paraquedismo"],
    },
  },
  {
    category: "Comidas e bebidas",
    words: {
      facil: ["Pizza", "Sorvete", "Hambúrguer", "Café", "Bolo", "Banana", "Suco", "Chocolate", "Pipoca", "Macarrão", "Queijo", "Pão", "Uva", "Maçã", "Água"],
      medio: ["Sushi", "Tapioca", "Feijoada", "Lasanha", "Panqueca", "Churrasco", "Coxinha", "Milk-shake", "Acarajé", "Brigadeiro", "Estrogonofe", "Churros", "Tacos", "Empada", "Burrito"],
      dificil: ["Fondue", "Ratatouille", "Ceviche", "Quiche", "Risoto", "Croissant", "Guacamole", "Paella", "Yakissoba", "Petit gâteau", "Caviar", "Macaron", "Ostras", "Carpaccio", "Alcachofra"],
    },
  },
  {
    category: "Lugares",
    words: {
      facil: ["Praia", "Escola", "Cinema", "Mercado", "Parque", "Hospital", "Igreja", "Aeroporto", "Padaria", "Museu", "Casa", "Rua", "Loja", "Praça", "Clube"],
      medio: ["Biblioteca", "Estádio", "Fazenda", "Teatro", "Shopping", "Cachoeira", "Academia", "Restaurante", "Zoológico", "Posto de gasolina", "Delegacia", "Prefeitura", "Rodoviária", "Tribunal", "Cemitério"],
      dificil: ["Observatório", "Embaixada", "Submarino", "Castelo", "Laboratório", "Farol", "Vinícola", "Templo", "Estúdio de gravação", "Estação espacial", "Caverna", "Trincheira", "Geleira", "Oásis", "Pântano"],
    },
  },
  {
    category: "Personagens",
    words: {
      facil: ["Homem-Aranha", "Batman", "Mickey Mouse", "Bob Esponja", "Papai Noel", "Pato Donald", "Hulk", "Super-Homem", "Mônica", "Chaves"],
      medio: ["Harry Potter", "Darth Vader", "Pikachu", "Mulher-Maravilha", "Shrek", "Minions", "Tarzan", "Coringa", "Naruto", "Goku"],
      dificil: ["Gollum", "Yoda", "Wolverine", "Frankenstein", "Drácula", "Jack Sparrow", "Indiana Jones", "RoboCop", "Godzilla", "Gandalf"],
    },
  },
  {
    category: "Elementos da Natureza",
    words: {
      facil: ["Árvore", "Flor", "Nuvem", "Sol", "Lua", "Estrela", "Fogo", "Pedra", "Raio", "Gelo"],
      medio: ["Furacão", "Vulcão", "Arco-íris", "Terremoto", "Tornado", "Neve", "Cacto", "Teia de aranha", "Cachoeira", "Semente"],
      dificil: ["Eclipse", "Aurora Boreal", "Estalactite", "Tsunami", "Gêiser", "Cometa", "Meteorito", "Fóssil", "Coral", "Duna"],
    },
  },
];
